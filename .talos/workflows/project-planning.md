...
- [ ] **State Tracking**: Update `talos-control/state.json` to reflect the transition to "In Progress".
...
- **Full Task List**: Copy-pasteable content for `talos-control/tasks.md` or `task.md`.
