...
- `ai-control/feature.md` is missing or marked as a stub.
...
4. Produce `ai-control/feature.md` as the consolidated output.
...
- `ai-control/feature.md` — the single source of truth for what must be built.
